...
public class OpenLevelTest{
	public static void main(String[] args) throws InvalidMoveException {
		...
		File newFile = new File("./computer_player/test_levels/open.dat");
		try {
			newFile.createNewFile();
			FileOutputStream saveToFile = new FileOutputStream("./computer_player/test_levels/open.dat");
